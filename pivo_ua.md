...
# Путінський ЛОГОС: програмні промови, діалоги без протоколу

**ЗМIСТ**:

[1. Путін у Палаті Двох Істин: Суд Озіриса](pivo_ua#1-путін-у-палаті-двох-істин-суд-озіриса)
...
## 1. ПУТІН У ПАЛАТІ ДВОХ ІСТИН: СУД ОЗІРИСА
